...
export function InstallPrompt() {
  ...
  const onInstallClick = async () => {
    import('@/lib/analytics').then(({ trackEvent }) => trackEvent('pwa_install_click'));
    const success = await handleInstall();
    if (success) {
      setShowPrompt(false);
      import('@/lib/analytics').then(({ trackEvent }) => trackEvent('pwa_install_success'));
    }
  };
  ...
  const handleDismiss = () => {
    ...
    import('@/lib/analytics').then(({ trackEvent }) => trackEvent('pwa_install_dismiss'));
  };
