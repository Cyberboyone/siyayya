    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-12 md:pt-20 pb-16 md:pb-24 overflow-visible">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center">
          ...
          >
            <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-[7.5rem] font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-[0.85] drop-shadow-sm italic">
              Buy, Sell &<br />
              Connect<br />
              <span className="text-primary inline-block pb-4 drop-shadow-sm">
                On Campus
              </span>
            </h1>
            <p className="text-base md:text-lg text-slate-600 dark:text-slate-400 mt-6 max-w-2xl mx-auto font-medium leading-relaxed">
