...
const SignIn = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      // Note: With Popup login, AuthRedirect will handle the navigation once the user is authenticated.
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      {/* 🔴 Redirect Handler removed. Handled declaratively by GuestRoute in App.tsx */}
    </div>
  );
};
