...
import { ArrowRight, LayoutDashboard, Phone } from "lucide-react";
...
const SignIn = () => {
  useSEO({
    ...
    description: "Sign in to Siyayya, your exclusive verified campus trading community.",
    noindex: true,
  });
    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-black text-foreground mb-2">Welcome to Siyayya</h1>
          <p className="text-sm text-muted-foreground font-medium px-4">
            Sign in or create your account to chat, save items, and post listings.
          </p>
        </div>

        <div className="glass-card p-6 sm:p-10 space-y-8 shadow-2xl border-white/10">
          {authView === "phone" ? (
            <PhoneAuthFlow onBack={() => setAuthView("options")} onSuccess={() => {}} />
          ) : (
            <>
              <div className="space-y-2 text-center">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-4">Secure Authentication</p>
                <p className="text-sm text-muted-foreground font-semibold">
                  Google is recommended for full account access. Phone sign-in is available for quick chatting.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <Button
                  variant="outline"
                  type="button"
                  className="w-full h-14 gap-3 rounded-2xl border-2 hover:bg-secondary/50 font-bold transition-all active:scale-95"
                ...
                <div className="bg-secondary/30 p-4 rounded-xl border border-white/5 space-y-2">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[11px] text-muted-foreground leading-relaxed">
                      <span className="font-bold text-foreground">New here?</span> After Google sign-in, you’ll complete a short profile with your campus, display name, and phone number.
                    </p>
                  </div>
                </div>
