        ...
        <div className="glass-card p-6 sm:p-10 space-y-8 shadow-2xl border-white/10">
          ...
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground font-semibold">
              Continue with Google to access your Siyayya account securely.
            </p>
          </div>
            ...
            <div className="bg-secondary/30 p-4 rounded-xl border border-white/5 space-y-2">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[11px] text-muted-foreground leading-relaxed">
                  <span className="font-bold text-foreground">New here?</span> After Google sign-in, you’ll complete a short profile with your campus and display name.
                </p>
              </div>
            </div>
