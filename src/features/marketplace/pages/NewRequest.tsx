          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700/80 leading-relaxed">
                        You're posting as a guest. <Link to="/signin" className="ml-1 font-black underline hover:text-blue-900 transition-colors">Sign in here.</Link>
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  rows={4}
                  placeholder="Details matter!"
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  className="w-full rounded-3xl border border-black/5 bg-white px-5 py-4 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/10 transition-all"
                />
              </div>
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-[#222222]/50 ml-1">Phone Number *</label>
                <Input 
              ...
              >
                {isSubmitting ? "Listing Request..." : "Post My Request"}
              </Button>
            </form>
          </div>
        </div>
        ...
        <AlertDialogContent className="rounded-[2.5rem] max-w-sm p-8 border-none shadow-2xl">
          <AlertDialogHeader className="items-center text-center">
            ...
            <AlertDialogDescription className="text-muted-foreground font-medium pt-2">
              Your request is now visible to everyone.
            </AlertDialogDescription>
          </AlertDialogHeader>
