    ...
    <div className="min-h-screen bg-background pb-28 md:pb-0">
      ...
      <div className="container max-w-3xl py-8">
        ...
        <div className="prose dark:prose-invert max-w-none text-muted-foreground space-y-6">
          <p>
            Welcome to Siyayya, the dedicated marketplace for your campus community. 
          ...
          <p>
            We aim to connect students and staff, fostering a micro-economy within the campus. Whether you're 
          ...
          <ul className="list-disc pl-5 space-y-2">
            <li><strong>Campus-Focused:</strong> Everything listed here is by someone within your campus community. No dealing with distant logistics.</li>
          ...
          <div className="mt-12 p-6 bg-secondary rounded-xl text-center">
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link to="/signin" className="inline-flex h-10 items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium shadow-sm hover:bg-accent hover:text-accent-foreground">
                Create Account
              </Link>
            </div>
          </div>
