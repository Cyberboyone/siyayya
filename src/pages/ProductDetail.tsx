    ...
    <>
      ...
      <div className="container max-w-3xl py-4">
        ...
        <div className="mt-8 border-t border-black/5 pt-8">
          ...
          <Link to={`/user/${product.ownerId}`} className="flex items-center gap-4 group block rounded-[1.5rem] p-5 border border-black/5 bg-surface hover:bg-muted/30 hover:shadow-lg transition-all duration-300">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] text-textSecondary font-bold uppercase tracking-widest mt-0.5 truncate opacity-60">{product.ownerDepartment || "Verified Community Member"}</p>
            </div>
