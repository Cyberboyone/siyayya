      ...
      <div className="container py-6">
        ...
        {isLoading ? (
          ...
          <>
            ...
            {filtersOpen && (
              <div className="mt-4 mb-8 rounded-3xl border border-black/5 bg-surface p-6 grid grid-cols-2 md:grid-cols-4 gap-6 animate-in fade-in slide-in-from-top-2 shadow-xl">
                <div>
