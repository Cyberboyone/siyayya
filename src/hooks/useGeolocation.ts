...
export const useGeolocation = (): GeolocationState => {
  ...
  useEffect(() => {
    ...
    const detect = async () => {
      ...
      if (gps) {
        console.log("[Geolocation] Detected via GPS:", gps.lat, gps.lng);
      ...
      console.log("[Geolocation] GPS failed or denied, trying IP fallback...");
      ...
      if (ip) {
        console.log("[Geolocation] Detected via IP:", ip.lat, ip.lng);
        const newState: GeolocationState = {
          lat: ip.lat,
          lng: ip.lng,
          isLoading: false,
      ...
      console.log("[Geolocation] IP fallback failed, using default (Campus).");
